...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [88100.186891, 5719865.855297, 383447.360963, 5857591.906214], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([88100.186891, 5719865.855297, 383447.360963, 5857591.906214], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Enquête Hirondelles 2026 - Choix des mailles à prospecter en Creuse</h2>';
        return titleElement;
    })(),
