...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldAliases', {'id': 'id', 'ID_new': 'Identifiant', 'CODE_POST': 'Code postal', 'NOM': 'Commune', 'NOM_2': 'Département', });
...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldImages', {'id': 'Hidden', 'ID_new': 'TextEdit', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'NOM_2': 'TextEdit', });
...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldLabels', {'ID_new': 'header label - always visible', 'CODE_POST': 'inline label - always visible', 'NOM': 'inline label - always visible', 'NOM_2': 'inline label - always visible', });
